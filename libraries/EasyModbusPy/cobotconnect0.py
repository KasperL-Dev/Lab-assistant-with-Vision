...
import time
import re
from EasyModbusPy.easymodbus.modbusClient import ModbusClient   #pip install easymodbus
import struct
SP=100 #speed    
HOST='169.254.255.186'  #voorwaarde dat dit IP adres ingesteld is op de robot, dat se PC een vast IP-adres met alleen het laatse getal ander heeft, en dat de cobot opstart verbonden met de PC
    ...
    def sendCobotPos(self,pstxt,SP=50):
        ...
        if (g!='0'): 
            ...
            while not "OK" in data.decode():
                ...
                print(stap)
                time.sleep(2)                 #5anders herhalen na 1 s tot einde bestand 	
    #voor 3
